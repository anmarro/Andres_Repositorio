...
reclas = r"C:\PIRINEOS\GDB\PIRINEOS.gdb\Reclas"

# Ruta y nombre de la tabla de salida de la herramienta Sample
out_table = r"C:\PIRINEOS\GDB\PIRINEOS.gdb\Sample_Output"
...
def intersecta_con_raster(ruta):
    ...
    ruta_temporal = r"C:\PIRINEOS\GDB\PIRINEOS.gdb\CapaRutaTemp"
